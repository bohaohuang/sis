...
ft_dir = r'/hdd/Results/inria_gamma/UnetCrop_inria_aug_gamma_0_PS(572, 572)_BS5_EP40_LR1e-06_DS20_DR0.1_SFN32'
ts_dir = r'/hdd/Results/inria_gamma/UnetCrop_inria_aug_gamma_0_PS(572, 572)_BS5_EP100_LR0.0001_DS60_DR0.1_SFN32'

model_name = ['base', 'finetune', 'scratch']
model_dir = [base_dir, ft_dir, ts_dir]
