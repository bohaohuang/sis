...
DECAY_STEP = 20
DECAY_RATE = 0.1
MODEL_NAME = 'gbdx_aug_grid_{}_building'
SFN = 32
RES101_DIR = r'/hdd6/Models/UNET_rand_gird/UnetCrop_inria_aug_grid_0_PS(572, 572)_BS5_EP100_LR0.0001_DS60_DR0.1_SFN32'
...
def main(flags):
    ...
    valid_num = int(len(file_list) * 0.2)
