    ...
    for th in [7]:
        for city_id in range(4):
            ...
            for tile_id in [1, 2, 3]:
                ...
                save_file_name = os.path.join(task_dir, '_post_{}_{}_{}_pred2.npy'.format(model_name, city_id, tile_id))
                ersa_utils.save_file(save_file_name, tower_pred)
                save_file_name = os.path.join(task_dir, 'no_post_{}_{}_{}_conf2.npy'.format(model_name, city_id, tile_id))
                ersa_utils.save_file(save_file_name, tower_conf)
                save_file_name = os.path.join(task_dir, 'no_post_{}_{}_{}_conn2.npy'.format(model_name, city_id, tile_id))
