...
def read_flag():
    ...
    parser.add_argument('--llh-file', type=str, default=LLH_FILE, help='path to log likelihood file dir')
    parser.add_argument('--t', type=float, default=T, help='Temperature for softmax')
    parser.add_argument('--pred-model-dir', type=str, default=PRED_DIR, help='pretrained model directory')
    ...
    flags.model_name = flags.model_name.format(flags.train_city, flags.t, flags.run_id)
    return flags
