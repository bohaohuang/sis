...
python finetune_inria_unet_loo_mmd.py --learning-rate=1e-5 --finetune-city=0 --llh-file=/dscrhome/bh163/misc/temp_files/unet_xregion_mmd_target_\{\}_5050.npy --pred-model-dir=/dscrhome/bh163/misc/unet_xregion