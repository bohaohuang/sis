...
MODEL_NAME = 'ResUnetCropBn_Inria_fr_resample_mean_reduced_EP-{}_DS-{}_LR-{}'
NUM_CLASS = 2
GPU = '0'
...
def test(flags, ep, ds, lr, save_dir):
    ...
    # initialize model
    flags.model_name = 'ResUnetCropBn_Inria_fr_resample_mean_reduced_EP-{}_DS-{}_LR-{}'.format(ep, ds, lr)
...
if __name__ == '__main__':
    ...
    for lr in [1e-4]:
        ...
        iou_mean = test(flags, 150, ds, lr, task_dir)

        '''file_name = flags.model_name.format(100, ds, lr) + '.npy'
        iou_mean = []
