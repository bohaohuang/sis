...
def main(flags):
    ...
    # define network
    model = deeplab.DeepLab(flags.num_classes, flags.patch_size, suffix=flags.model_suffix,
                            learn_rate=flags.learning_rate, decay_step=flags.decay_step, decay_rate=flags.decay_rate,
