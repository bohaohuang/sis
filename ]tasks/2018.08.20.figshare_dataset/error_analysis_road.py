...
def make_cmp_plot(rgb, truth, base, ugan, x, y, window_size, city_str):
    ...
    plt.subplot(133)
    make_subplot(ugan_patch, ugan, truth_patch, 'UGAN')
    plt.tight_layout()
...
truth_dir = r'/media/ei-edl01/data/uab_datasets/Mass_road/data/Original_Tiles'
if cnn_name == 'unet':
    base_dir = r'/hdd/Results/Road/UnetCrop_road_0_PS(572, 572)_BS5_EP80_LR0.0001_DS60_DR0.1_SFN32/Mass_road/pred'
    ugan_dir = r'/hdd/Results/Road/UnetGAN_V3ShrinkRGB_road_gan_0_PS(572, 572)_BS20_EP60_LR0.0001_1e-06_1e-06_' \
               r'DS60.0_60.0_60.0_DR0.1_0.1_0.1/Mass_road/pred'
else:
    base_dir = r'/hdd/Results/Road/UnetCrop_road_0_PS(572, 572)_BS5_EP80_LR0.0001_DS60_DR0.1_SFN32/Mass_road/pred'
    ugan_dir = r'/hdd/Results/Road/UnetGAN_V3ShrinkRGB_road_gan_0_PS(572, 572)_BS20_EP60_LR0.0001_1e-06_1e-06_' \
               r'DS60.0_60.0_60.0_DR0.1_0.1_0.1/Mass_road/pred'

for city_num in range(1):
    for val_img_cnt in tqdm(range(1, 49)):
        img_save_dir = os.path.join(img_dir, 'road_base_gan')
