...
DECAY_STEP = '20,20'
DECAY_RATE = '0.1,0.1'
MODEL_NAME = 'road_xregion_slow_{}_{}_ld{}'
SFN = 32
SAVE_EPOCH = 5
FINETUNE_CITY = 0
...
def read_flag():
    ...
    flags.model_name = flags.model_name.format(flags.finetune_city, flags.run_id, flags.lada)
    return flags
...
def main(flags):
    ...
    file_list_train = uabCrossValMaker.make_file_list_by_key(idx, file_list, [1, 2])
    file_list_valid = uabCrossValMaker.make_file_list_by_key(idx, file_list, [1, 2])
