...
for city_id in [2]:
    ...
    model_dir_ugan = r'/hdd/Results/ugan/UnetGAN_inria_gan_real_{}_2_fixed_PS(572, 572)_BS4_EP35_LR0.0001_1e-05_1e-06_DS30.0_10.0_30.0_DR0.1_0.1_0.1/inria'.format(city_id)
