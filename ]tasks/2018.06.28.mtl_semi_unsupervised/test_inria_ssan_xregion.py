...
model_list = [
    r'SSAN_Unet_inria_xregion_slow_0_0_ld0.1_PS(572, 572)_BS5_EP30_LR1e-06_1e-06_DS20.0_20.0_DR0.1_0.1',
]

for model_dir in model_list:
    for load_epoch in range(0, 30, 5):
        model_dir = os.path.join(r'/hdd6/Models/Inria_GAN/SSAN/', model_dir)
        ...
        model.evaluate(file_list_valid, file_list_valid_truth, parent_dir, parent_dir_truth,
                       ...
                       save_result_parent_dir='ugan', ds_name='epoch_{}'.format(load_epoch),
