...
python train_cityscapes_pspnet.py --decay-step=20 --decay-rate=0.1 --learning-rate=1e-3 --res-dir=/dscrhome/bh163/misc/pspnet101 --data-dir=/work/bh163/uab_datasets/Cityscapes