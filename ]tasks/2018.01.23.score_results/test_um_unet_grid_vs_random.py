...
for runType in ['grid', 'random']:
    for runId in range(5):
        ...
        model_dir = r'/hdd/Models/UNET_rand_gird/UnetCrop_um_aug_{}_{}_PS(572, 572)_BS5_EP100_LR0.0001_DS60_DR0.1_SFN32'.format(runType, runId)
        ...
        model.evaluate(file_list_valid, file_list_valid_truth, parent_dir, parent_dir_truth,
                       ...
                       save_result_parent_dir='grid_vs_random', ds_name='um')
