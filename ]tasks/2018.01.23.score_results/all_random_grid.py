...
width = 0.3
bp1 = plt.boxplot(np.transpose(result_all_deeplab), positions=positions,widths=width)
bp2 = plt.boxplot(np.transpose(result_all_unet), positions=positions+width, widths=width)
...
positions = np.arange(2)
width = 0.3
bp1 = plt.boxplot(np.transpose(result_all_unet), positions=positions,widths=width)
bp2 = plt.boxplot(np.transpose(result_all_deeplab), positions=positions+width, widths=width)
set_box_color(bp1, cm.tab10(0), 'red')
set_box_color(bp2, cm.tab10(1), 'green')
plt.xticks(np.arange(len(run_types))+width/2, run_types)
plt.plot([], c=cm.tab10(0), label='U-Net')
