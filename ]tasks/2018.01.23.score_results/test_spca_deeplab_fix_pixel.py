...
for patch_size, batch_size in zip(patch_sizes, batch_sizes):
    ...
    for runId in range(5):
        ...
        model_dir = r'/hdd6/Models/DeepLab_fix_pixel/DeeplabV3_spca_aug_psbs_{}_PS({}, {})_BS{}_EP100_LR1e-05_DS40_DR0.1_SFN32'.\
        ...
        model.evaluate(file_list_valid, file_list_valid_truth, parent_dir, parent_dir_truth,
                       ...
                       save_result_parent_dir='fix_pixel_fix_test', ds_name='spca')
