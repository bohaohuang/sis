...
for runType in ['grid', 'random']:
    for runId in range(5):
        ...
        model_dir = r'/hdd/Models/DeepLab_rand_grid/DeeplabV3_res101_inria_aug_{}_{}_PS(321, 321)_BS5_EP100_LR1e-05_DS40_DR0.1_SFN32'.\
        ...
        model.evaluate(file_list_valid, file_list_valid_truth, parent_dir, parent_dir_truth,
                       ...
                       save_result_parent_dir='grid_vs_random', ds_name='inria')
