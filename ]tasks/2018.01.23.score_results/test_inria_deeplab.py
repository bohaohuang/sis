...
for runId in [0]:
    ...
    model_dir = r'/hdd/Models/DeeplabV2_inria_aug_grid_0_PS(321, 321)_BS5_EP100_LR0.0005_DS40_DR0.1_SFN32'.format(runId)
    ...
    model = uabMakeNetwork_DeepLabV2.DeeplabV2({'X':X, 'Y':y},
                                               trainable=mode,
