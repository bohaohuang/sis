...
python train_inria_deeplab_control_class.py --run-id=1 --patch-dir=/dscrhome/bh163/code/sis/]tasks/2018.03.02.res_gan --res-dir=/dscrhome/bh163/resnet_v1_101.ckpt