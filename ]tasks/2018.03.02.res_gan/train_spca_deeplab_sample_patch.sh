...
python train_spca_deeplab_sample_patch.py --run-id=0 --patch-dir=/dscrhome/bh163/code/sis/]tasks/2018.03.02.res_gan --res-dir=/dscrhome/bh163/resnet_v1_101.ckpt