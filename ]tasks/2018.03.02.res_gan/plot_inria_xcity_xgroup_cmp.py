...
incity_record_a = np.zeros((len(incity_dir), 6))
incity_record_b = np.zeros((len(incity_dir), 6))
xcity_record_a = np.zeros((len(xcity_dir), 6))
xcity_record_b = np.zeros((len(xcity_dir), 6))
xgroup_record_a = np.zeros((len(xgroup_dir), 6))
xgroup_record_b = np.zeros((len(xgroup_dir), 6))
