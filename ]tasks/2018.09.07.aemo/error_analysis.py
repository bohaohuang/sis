...
truth_dir = r'/home/lab/Documents/bohao/data/aemo'
...
ft_dir = r'/hdd/Results/aemo/unet_aemo_hist_rgb_finetune_bn_PS(572, 572)_BS5_EP130_LR0.001_DS60_DR0.1/default/pred'

eval_files = ['_'.join(os.path.basename(f)[:-4].split('_')[:2]) for f in glob(os.path.join(base_dir, '*.png'))]

for f in eval_files:
    img_save_dir = os.path.join(img_dir, 'cmp_1')
