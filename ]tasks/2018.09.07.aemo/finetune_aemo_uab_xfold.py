...
def read_flag():
    ...
    flags.model_name = flags.model_name.format(flags.xfold, flags.run_id)
    return flags
...
def main(flags):
    ...
    train_ids = [i for i in range(6) if i not in valid_ids]
    file_list_train = uabCrossValMaker.make_file_list_by_key(idx, file_list, train_ids)
