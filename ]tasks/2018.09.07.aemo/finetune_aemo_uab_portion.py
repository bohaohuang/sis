...
DECAY_RATE = 0.1
START_LAYER = 10
MODEL_NAME = 'aemo_portion_{}_leave_front{}'
DS_NAME = 'aemo'
SFN = 32
PORTION = 0.7
...
def read_flag():
    ...
    parser.add_argument('--portion', type=float, default=PORTION, help='portion of the input')

    flags = parser.parse_args()
    flags.input_size = (flags.input_size, flags.input_size)
    flags.tile_size = (flags.tile_size, flags.tile_size)
    flags.model_name = flags.model_name.format(flags.run_id, flags.portion)
    return flags
