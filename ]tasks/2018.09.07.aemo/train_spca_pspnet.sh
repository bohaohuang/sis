...
python train_spca_pspnet.py --decay-step=40 --decay-rate=0.1 --learning-rate=1e-4 --res-dir=/dscrhome/bh163/misc/pspnet101 --data-dir=/work/bh163/uab_datasets/spca