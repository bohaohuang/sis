...
model_dir = r'/hdd6/Models/aemo/aemo_hist/UnetCrop_aemo_ft_0_PS(572, 572)_BS5_EP80_LR0.001_DS30_DR0.1_SFN32'
ds_name = 'aemo_hist'
...
model.evaluate(file_list_valid, file_list_valid_truth, parent_dir, parent_dir_truth,
               ...
               save_result_parent_dir='aemo/uab', ds_name=ds_name, best_model=False, load_epoch_num=75)'''
