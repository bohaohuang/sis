...
if __name__ == '__main__':
    ...
    model_dir = ['confmap_uab_UnetCrop_aemo_ft_1_PS(572, 572)_BS5_EP80_LR0.001_DS30_DR0.1_SFN32',
                 'confmap_uab_UnetCrop_aemo_hd_0_wf1_PS(572, 572)_BS5_EP20_LR1e-05_DS10_DR0.1_SFN32',
                 'confmap_uab_UnetCrop_aemo_hd_0_wf2_PS(572, 572)_BS5_EP20_LR1e-05_DS10_DR0.1_SFN32',
                 'confmap_uab_UnetCrop_aemo_hd_0_wf3_PS(572, 572)_BS5_EP20_LR1e-05_DS10_DR0.1_SFN32',
                 'confmap_uab_UnetCrop_aemo_hd_0_wf4_PS(572, 572)_BS5_EP20_LR1e-05_DS10_DR0.1_SFN32',
                 ]
    model_name = ['Orig', 'Weight 1', 'Weight 2', 'Weight 3', 'Weight 4']
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(os.path.join(img_dir, 'pr_cmp_uab_hardsample_reweight.png'))
    plt.close()
