...
python finetune_aemo_dcc.py --from-scratch=True --par-dir=aemo_align --learn-rate=1e-3,1e-4 --start-layer=10 --model-dir=/work/bh163/misc/unet_reweight --data-dir=/work/bh163/data/aemo_align