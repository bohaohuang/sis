...
python finetune_aemo_dcc.py --from-scratch=True --learn-rate=1e-3 --start-layer=10 --model_dir=/work/bh163/misc/unet_reweight --data-dir=/work/bh163/data/aemo_hist2