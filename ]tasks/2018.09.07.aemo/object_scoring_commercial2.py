...
class spClass_confMapToPolygonStructure_v2:
    ...
    def addCommercialLabelToObjectStructure(self, confidenceImage, clear_coords=False):
        if not self.objectStructure.empty:
            ...
            if clear_coords:
                print(self.objectStructure.shape)
                self.objectStructure = self.objectStructure.loc[self.objectStructure['isCommercial'] == True]
                print(self.objectStructure.shape)
