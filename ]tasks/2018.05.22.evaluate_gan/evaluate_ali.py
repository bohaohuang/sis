...
for lr in ['5e-06']:
    for z_dim in [500]:
        for DS in [400.0]:
            ...
            file_name = os.path.join(new_task_dir, 'ali_inria_lr{}_z{}_ds{}.csv'.format(lr, z_dim, DS))
            patch_file_name = os.path.join(new_task_dir, 'ali_inria_lr{}_z{}_ds{}.txt'.format(lr, z_dim, DS))
