...
def read_flag():
    ...
    parser.add_argument('--train-city', type=str, default=TRAIN_CITY, help='city id to leave-out in training')

    flags = parser.parse_args()
    flags.input_size = (flags.input_size, flags.input_size)
    flags.tile_size = (flags.tile_size, flags.tile_size)
    flags.model_name = flags.model_name.format('_'.join(flags.train_city.split(',')))
    return flags
