...
for run_ids in run_list:
    tf.reset_default_graph()

    city_str = '_'.join([city_list[a] for a in run_ids])
    print(city_str)
    model_dir = r'/hdd6/Models/city_control/DeeplabV3_inria_aug_train_{}_PS(321, 321)_BS5_EP100_LR1e-05_DS40_DR0.1_SFN32'.\
        format(city_str)
    ...
    model.evaluate(file_list_valid, file_list_valid_truth, parent_dir, parent_dir_truth,
                   ...
                   save_result_parent_dir='control_city', ds_name='inria')
