...
tile_size = [5000, 5000]
save_dir = '/hdd/Temp/IGARSS2018/UnetCrop'
model_dir = r'/hdd/Models/exp1/UnetCrop_inria_aug_grid_1_PS(572, 572)_BS5_EP100_LR0.0001_DS60_DR0.1_SFN32'
...
for size in input_sizes:
    ...
    for file_name, file_name_truth in zip(file_list_valid, file_list_valid_truth):
        ...
        image_pred = uabUtilreader.un_patchify_shrink(result,
                                                      [tile_size[0] + 184, tile_size[1] + 184],
                                                      tile_size,
                                                      input_size,
                                                      [input_size[0] - 184, input_size[1] - 184],
                                                      overlap=92)
