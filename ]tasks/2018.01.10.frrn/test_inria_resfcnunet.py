...
for runId in [0]:
    ...
    model_dir = r'/hdd/Models/ResFcnUnet_inria_aug_grid_{}_PS(224, 224)_BS5_EP100_LR0.0001_DS60_DR0.1_SFN32'.format(runId)
    ...
    model = uabMakeNetwork_ResFCN.ResFcnUnetModel({'X':X, 'Y':y},
                                                  trainable=mode,
