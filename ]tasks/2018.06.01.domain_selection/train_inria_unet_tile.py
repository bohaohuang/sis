...
def main(flags):
    ...
    prior_file = os.path.join(flags.group_file_dir, 'prior_gmm_n_comp_35_unet.txt')
    with open(prior_file, 'r') as f:
        priors = f.readlines()
    city_alpha = [float(a) for a in priors[city_dict[flags.train_city]].split(',')]
