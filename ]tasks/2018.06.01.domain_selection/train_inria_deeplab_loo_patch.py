...
DECAY_STEP = 40
DECAY_RATE = 0.1
MODEL_NAME = 'inria_{}_loo_patch_{}'
SFN = 32
TRAIN_CITY = 'austin'
RES101_DIR = r'/hdd6/Models/resnet_v1_101.ckpt'
GROUP_FILE_DIR = r'/media/ei-edl01/user/bh163/tasks/2018.06.01.domain_selection'
...
def main(flags):
    patch_prior = np.load(os.path.join(flags.group_file_dir, 'unet_{}_patch_prior.npy'.format(flags.train_city)))
    ...
    dataReader_train = uabDataReader.ImageLabelReaderPatchSampleControl(
        ...
        patch_prior, dataAug='flip,rotate', block_mean=np.append([0], img_mean))
