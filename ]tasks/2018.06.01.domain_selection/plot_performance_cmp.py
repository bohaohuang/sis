...
if model_type == 'deeplab':
    model_list = [r'/hdd/Results/domain_selection/DeeplabV3_inria_aug_train_chicago_kitsap_tyrol-w_vienna_PS(321, 321)_BS5_EP100_LR1e-05_DS40_DR0.1_SFN32',
                  ...
                  r'/hdd/Results/domain_selection/DeeplabV3_inria_austin_0_PS(321, 321)_BS5_EP40_LR1e-06_DS20_DR0.1_SFN32']
    model_name_show = ['LOO', 'Base', 'Scratch', 'Finetune']
    ...
    for plt_cnt, model_name in enumerate(model_list):
        ...
        plt.xticks(X+width*1.5, city_list+['Over All'])
        plt.xlabel('City')
        plt.ylabel('IoU')
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(img_dir, 'deeplab_austin_cmp.png'))
    plt.show()
else:
    model_list = [
        ...
        r'/hdd/Results/domain_selection/UnetCrop_inria_austin_0_PS(572, 572)_BS5_EP100_LR0.0001_DS60_DR0.1_SFN32',
