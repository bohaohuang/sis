...
for runType in ['focal', 'xent']:
    for runId in [3]:
        tf.reset_default_graph()

        model_dir = r'/hdd/Models/Deeplab_focal/DeeplabV3_inria_aug_{}_valiou_{}_PS(321, 321)_BS5_EP100_LR1e-05_DS40_DR0.1_SFN32'.\
        ...
        model.evaluate(file_list_valid, file_list_valid_truth, parent_dir, parent_dir_truth,
                       ...
                       save_result_parent_dir='focal', ds_name='inria')
